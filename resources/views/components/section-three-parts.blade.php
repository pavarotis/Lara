<div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
    ...
    <!-- Part 2: Actions/Buttons -->
    @if(isset($actions))
        <div class="fi-section-content" style="padding-top: 1.5rem; padding-bottom: 1.5rem; padding-left: 1.5rem; padding-right: 1.5rem; border-top: 1px solid rgba(156, 163, 175, 0.3);">
            {{ $actions }}
        </div>
    @endif
